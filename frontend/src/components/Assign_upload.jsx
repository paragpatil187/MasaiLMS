...
const Assign_upload = () => { 
  ...
  const saveAssignment = () =>{
    const data = {assignment_title,assignment_teacher,assignment_problem,assignment_type,assignment_date,assignment_time}
    fetch("https://lmsbackend22.herokuapp.com/assignment/",{
      method :'POST',
      headers:{
  ...
  return (
    <div style={{height:'100vh'}}>
        <div className='upload'>
            ...
            <hr />
            <input type="text" value={assignment_title} onChange={(e)=>{ setAssignment_title(e.target.value)}} name='assignment_title' placeholder='Enter Assignment' />
            <input type="text" value={assignment_teacher} onChange={(e)=>{ setAssignment_teacher(e.target.value)}} name='assignment_teacher' placeholder='Enter Instructor Name ' />
            <input type="text" value={assignment_problem} onChange={(e)=>{ setAssignment_problem(e.target.value)}} name='assignment_problem' placeholder='Assignment Problem'/>
            <input type="text" value={assignment_type} onChange={(e)=>{ setAssignment_type(e.target.value)}} name='assignment_type' placeholder='Assignment Task'/>
