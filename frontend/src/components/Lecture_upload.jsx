...
const Lecture_upload = () => { 
  ...
  const saveLecture = () =>{
    const data = {lecture_title,lecture_teacher,lecture_type,video_type,lecture_date,lecture_time}
    fetch("https://lmsbackend22.herokuapp.com/lecture/",{
      method :'POST',
      headers:{
  ...
  return (
    <div style={{height:'100vh'}}>
        <div className='upload'>
            ...
            <input type="text" value={lecture_type} onChange={(e)=>{ setLecture_type(e.target.value)}} name='lecture_type' placeholder='Lecture Problem (Coading / DSA)'/>
            <input type="text" value={video_type} onChange={(e)=>{ setVideo_type(e.target.value)}} name='video_type' placeholder='Lecture class (Live/ recording)'/>
